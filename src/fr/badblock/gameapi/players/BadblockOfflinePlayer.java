...
/**
 * Donne les anciennes données d'un joueur ayant déconnecté aprčs le début de la
 * partie.<br>
...
public interface BadblockOfflinePlayer extends BadblockPlayerData {
	/**
	 * Récupčre le CustomObjective vu par le joueur avant la déconnection
	 * 
	...
	/**
	 * Récupčre la fausse dimension dans laquelle le joueur était (afin de lui
