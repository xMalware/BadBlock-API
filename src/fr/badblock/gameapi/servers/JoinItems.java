...
public interface JoinItems {
	/**
	 * Clear l'inventaire du joueur ŕ la connection (par défaut activé)
	 */
	public void doClearInventory(boolean clear);

	/**
	 * A appeler lorsqu'il faut arręter les actions demandées (par exemple,
	 * lorsque la partie commence)
	 */
	public void end();

	/**
	 * Demande ŕ l'API de gérer l'item permettant de voir les achievements
	 * 
	 * @param slot
	 *            Le slot
	 * @param game
	...
	/**
	 * Demande ŕ l'API de gérer l'item de kit
	 * 
	 * @param slot
	 *            Le slot dans lequel mettre l'item ŕ la connection
	 * @param kits
	...
	/**
	 * Demande ŕ l'API de gérer l'item pour quitter la partie
	 * 
	 * @param slot
	 *            Le slot
	...
	/**
	 * Demande ŕ l'API de gérer l'item de team (ŕ appeler aprčs avoir charger
	 * les teams)
	 * 
	 * @param slot
	 *            Le slot
	...
	/**
	 * Demande ŕ l'API de gérer l'item de vote (choix de la map)
	 * 
	 * @param slot
	 *            Le slot
	 */
	...
	/**
	 * Demande ŕ l'API de gérer l'item VIP (affiche les avantages)
	 * @param slot Le slot
	 */
	public void registerVipItem(int slot);
	
	/**
	 * Demande ŕ l'API de gérer un item custom
	 * @param slot Le slot
