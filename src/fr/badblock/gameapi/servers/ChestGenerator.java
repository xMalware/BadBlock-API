...
public interface ChestGenerator {
	 ...
	 * @param save
	 *            Si la configuration doit ętre sauvegardée avec cet item
	 */
	public void addItemInConfiguration(ItemStack item, int probability, boolean save);

	/**
	 * Aprčs que cette méthode soit appelée, les coffres ouverts par les joueurs
	...
	/**
	 * Vérifie si le générateur ŕ été configuré
	 * 
