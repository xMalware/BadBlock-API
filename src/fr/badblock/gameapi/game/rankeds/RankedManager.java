...
public abstract class RankedManager {
	...
	public abstract void getTotalPoints(String gameName, BadblockPlayer player, Callback<Integer> callback);
	public abstract void getMonthPoints(String gameName, BadblockPlayer player, Callback<Integer> callback);
