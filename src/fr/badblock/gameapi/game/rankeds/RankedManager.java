...
public abstract class RankedManager {
	...
	public abstract void getTotalPoints(BadblockPlayer player, Callback<Integer> callback);
	public abstract void getMonthPoints(BadblockPlayer player, Callback<Integer> callback);
