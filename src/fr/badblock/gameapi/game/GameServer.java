...
public interface GameServer {
	...
	public static enum WhileRunningConnectionTypes {
		...
		SPECTATOR,
		/**
		 * Récupčre les données joueurs stockées si le joueur avait déco<br>
		 * Si cette politique n'est pas utilisable ŕ chaque fois, vous pouvez
	 ...
	 * Autrement, utilisé automatiquement ŕ la fin de la partie
	 */
	...
	/**
	 * Récupčre la date/heure de début du jeu (GameState = RUNNING)
	 * 
	...
	/**
	 * Définit le traitement des joueurs si il se reconnecte aprčs le début de
	 * la partie
	 * 
	 * @param type
