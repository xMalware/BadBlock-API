 ...
 * </ul>
 * Le résultat doit en théorie être traduit pour le joueur directemment (la traduction n'est pas sur le web) et être spécifique à chaque joueur/langue<br>
 * Utiliser {@link BadblockPlayer#postResult(Result)}<br>
 * Pour les noms, possibilité d'utiliser [avatar:pseudo] et [img:example.png] pour afficher des images.
 * 
 * @author LeLanN
 */
...
public class Result {
	 ...
	 * @param name Le nom (interne) de la catégorie
