...
public interface BadConfiguration {
	 ...
	 * @param clazzValue Le type de la valeur
	 * @return La valeur (les modifications ne s'appliquent pas à la configuration)
	 */
	 ...
	 * @param key La clé de la valeur
	 * @param clazzValue Le type de la valeur
	 * @param def La valeur par défaut (sera set si non trouvéee)
	 * @return La valeur (les modifications ne s'appliquent pas à la configuration)
	 */
	 ...
	 * @param key La clé de la sous-section
