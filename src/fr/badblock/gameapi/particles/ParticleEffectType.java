...
public enum ParticleEffectType {
	 ...
	 * Une particule affichée lors de l'explosion d'une TNT ou d'un creeper
	 * <ul>
	 * <li>Ressemble à une multitude de balles grises qui disparaissent
	 ...
	 * <ul>
	 * <li>Ressemble à une goutte bleue
	 * <li>La speed value n'a aucune influence
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>Ressemble à un petit carré bleu
	 * <li>La speed value n'a aucune influence
	 * </ul>
	 */
	SUSPENDED("suspended", 7, null, true),
	/**
	 * Une particule affichée lorsque l'on est prêt de la bedrock
	 * <ul>
	 * <li>Ressemble à un petit carré gris
	 * <li>La speed value n'a aucune influence
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>Ressemble à un petit tourbillon blanc
	 * <li>Si à 0, la particule n'ira que vers le haut
	 * </ul>
	 */
	SPELL("spell", 13),
	/**
	 ...
	 * <ul>
	 * <li>Ressemble à une croix blanche
	 * <li>Si à 0, la particule n'ira que vers le haut
	 * </ul>
	 */
	...
	/**
	 * Une particule affichée par les sorcières
	 * <ul>
	 * <li>Ressemble à une croix violette
	 * <li>Si à 0, la particule n'ira que vers le haut
	 * </ul>
	 */
