...
@Getter
public enum BadblockInPackets {
	HANDSHAKE(Handshake.class), LOGIN_START(LoginStart.class), PLAY_ABILITIES(
			PlayInAbilities.class), PLAY_ARM_ANIMATION(PlayInArmAnimation.class), PLAY_BLOCK_DIG(
					PlayInBlockDig.class), PLAY_BLOCK_PLACE(PlayInBlockPlace.class), PLAY_CHAT(
							PlayInChat.class), PLAY_CLIENT_COMMAND(PlayInClientCommand.class), PLAY_CLOSE_WINDOW(
