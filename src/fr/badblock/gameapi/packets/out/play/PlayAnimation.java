...
/**
 * Packet qui fait joueur une 'animation' (mouvement) ŕ une entité.
 * 
 * @author LeLanN
 */
public interface PlayAnimation extends BadblockOutPacket {
	...
	/**
	 * Récupčre l'id de l'entité devant faire le mouuvement
	 * 
	 * @return L'id
	 */
