...
/**
 * Le packet envoyé pour dire au client d'afficher un objectif déjŕ connu.
 * 
 * @author LeLanN
 */
public interface PlayScoreboardDisplayObjective extends BadblockOutPacket {
	...
	public enum ObjectivePosition {
		/**
		 * Dans la tablist (ŕ côté du pseudo du joueur), généralement la vie du
		 * joueur
		 */
		LLST((byte) 0),
		/**
		 * Le scoreboard en lui-męme
		 */
		SIDEBAR((byte) 1),
		/**
