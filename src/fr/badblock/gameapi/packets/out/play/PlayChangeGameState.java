...
public interface PlayChangeGameState extends BadblockOutPacket {
	/**
	 * Représente les différentes choses pouvant ętre appelée avec
	...
	/**
	 * Récupčre ce qu'il faut changer
	 * 
	...
	/**
	 * Récupčre la valeur du gamestate. Voir {@link GameState} POur connaître
	 * les valeurs possibles (rien écrit = pas de valeur particuličre).
	 * 
	 * @return La valeur
	 */
	 ...
	 * valeurs possibles (rien écrit = pas de valeur particuličre).
	 * 
	 * @param value
	 *            La valeur
	 * @return Le packet
