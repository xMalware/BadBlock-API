...
public interface PlayChangeGameState extends BadblockOutPacket {
	 ...
	 * @param state Ce qu'il faut changer
	 * @return Le packet
	 */
	public PlayChangeGameState setState(GameState state);
	
	/**
	 * Récupère la valeur du gamestate. Voir {@link GameState} POur connaître les valeurs possibles (rien écrit = pas de valeur particulière).
	 * @return La valeur
	 */
	public float getValue();
	
	/**
	 * Définit la valeur du gamestate. Voir {@link GameState} POur connaître les valeurs possibles (rien écrit = pas de valeur particulière).
	...
	/**
	 * Représente les différentes choses pouvant être appelée avec {@link PlayChangeGameState}
	 * @author LeLanN
	 */
	public static enum GameState {
		 ...
		 * <li>102 : montre le message indiquant comment sauter<li>
		 * <li>103 : montre le message indiquant comment ouvrir l'inventaire<li>
		 * </ul>
		 */
		DEMO_MESSAGE(5),
		ARROW_HIT_PLAYER(6),
