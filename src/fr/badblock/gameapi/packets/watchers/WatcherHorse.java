...
public interface WatcherHorse extends WatcherAgeable {
	public enum HorseArmor {
		NO_ARMOR(0), IRON_ARMOR(1), GOLD_ARMOR(2), DIAMOND_ARMOR(3);
	...
	public enum HorseFlag {
		IS_TAME(0x02), HAS_SADDLE(0x04), HAS_CHEST(0x08), IS_BRED(0x10), IS_EATING(0x20), IS_REARING(0x40), MOUTH_OPEN(
				0x80);
