...
public interface PlayInEntityAction extends BadblockInPacket {
	...
	/**
	 * La valeur de l'action. Actuellement, utilisé uniquement par {@link EntityActions#RIDING_JUMP} (représente la force du saut, de 0 à 100).
	...
	/**
	 * Représente les différentes actions possibles pour {@link PlayInEntityAction}
	 * @author LeLanN
	 */
