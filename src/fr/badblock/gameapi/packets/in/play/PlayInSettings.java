...
/**
 * Packet envoyé par le client lorsqu'il change ses paramčtres
 * 
 * @author LeLanN
 */
public interface PlayInSettings extends BadblockInPacket {
	...
	/**
	 * Récupčre m'activation du chat du joueur
	 * 
	 * @return L'activation
	 */
	 ...
	 * <li>0x10 : Jambičre de gauche activée
	 * <li>0x20 : Jambičre de droite activée
	...
	/**
	 * Récupčre la view distance du joueur en chunk
	 * 
