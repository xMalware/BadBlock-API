 ...
 * <li>Un projectile si la source du projectile n'est pas une entité vivante (par exemple avec un dispenser).</li>
 * Cet event est aussi appelé si l'entité a été en combat dans les quelques dernières secondes et est morte de chute,
 * feu, ... Utiliser le {@link #getLastDamageCause()} pour ça.<br>
 * {@link #getFightType()} donne le type du dernier combat (CàC, TàD, potion, custom)
 * @author LeLanN
 */
...
public class FightingDeathEvent extends FakeDeathEvent {
	...
	@Getter private final FightingDeaths  fightType;
