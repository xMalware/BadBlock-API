...
/**
 * Représente une courbe paramétrée tridimensionnelle pour être utiliser pour des particules, par <b>exemple</b>.
 * La courbe peut être bidimensionnelle, il suffit de définir une de ses coordonnées comme fixe.<br>
 * On rappel qu'une courbe paramétrée peut être :
 * <ul>
 * <li>De la famille des cercles (cercle, ellipse, spirale) et leurs équivalents tridimensionnels</li>
 * <li>Une droite</li>
...
public abstract class ParametricCurve3D {
	 ...
	 * @param t La variable t c'est à dire la 'position' dans la courbe paramétrique
