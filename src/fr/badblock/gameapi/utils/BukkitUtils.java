...
public class BukkitUtils {
	...
	/**
	 * Récupčre un environement de monde (nether, end, overworld) ŕ partir de
	 * son id
	 * 
	 * @param id
	 *            L'id
	...
	/**
	 * Récupčre les joueurs étant entrain de joueur (hors spectateurs)
	 * 
	 * @return Les joueurs
	 */
	...
	/**
	 * Récupčre tous les joueurs connectés sur le serveur en tant que BadblockPlayer
	 * 
	 * @return Les joueurs
	 */
	 ...
	 *            Les locatioins
	 * @param whenNoTp
	 *            Lŕ ou tp quand le joueur ne doit pas ętre tp avec les autres
	 * @param doTp
	 *            Vérifie si le joueur doit ętret p
	 */
	...
	/**
	 * Permet de changer un block de maničre temporaire
	 * 
	 * @param block
	 *            Le block
	 * @param newType
	 *            Le type ŕ mettre temporairement
	 * @param newData
	 *            La data ŕ mettre temporairement
	 * @param ticks
	 ...
	 * @throws IOException En cas de problčme avec la lecture du JAR
	 */
