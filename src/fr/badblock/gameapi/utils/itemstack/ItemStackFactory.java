...
/**
 * Classe permettant de créer un item stack complexe de maničre beaucoup plus
 * simple.<br>
...
public interface ItemStackFactory {
	 ...
	 * 
	 * @param amount Le nombre d'item ŕ créer
	...
	/**
	 * Retourne une nouvelle factory avec les męmes paramčtres
	 * 
	 ...
	 * 
	 * @param displayName
	 *            Le displayName ŕ mettre ŕ l'item
	 * @return La factory
	 */
	...
	/**
	 * Permet de 'dire' ŕ la factory d'utiliser l'I18n pour displayName et lore
	 * 
	 * @param locale
	 *            La langue utilisée
	 */
