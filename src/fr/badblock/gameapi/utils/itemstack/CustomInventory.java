 ...
 * Utiliser {@link fr.badblock.gameapi.GameAPI#createCustomInventory(int, String)} pour l'obtenir.
 * @author LeLanN
 */
public interface CustomInventory {
	/**
	 * Permet d'ajouter un item cliquable dans l'inventaire. Si déjà placé, il sera simplement remplacé.
	 * Le callback sera appelé si un joueur clique sur l'item.
	 * 
	 * @param line La ligne de l'item (commence à 0 !)
	 * @param slot Le slot à utilisé (commence à 0 !)
	 * @param event Le callback qui sera appelé
	 */
	 ...
	 * 
	 * @param slot Le slot à utilisé (commence à 0 !)
	 * @param item L'item à placer. Si null, l'item sera supprimé [comme avec removeItem()]. Ici, on attend un itemExtra déjà  'configuré'.
	 */
