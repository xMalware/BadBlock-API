...
public interface CustomMerchantInventory {
	...
	/**
	 * Applique les offres choisies ŕ un villageois
	 * 
	 * @param villager
	 *            Le villageois
	 */
	...
	/**
	 * Récupčre les objets vendables par le marchant
	 * 
	...
	/**
	 * Permet d'ouvrir l'inventaire ŕ un joueur
	 * 
	 * @param player
	 *            Le joueur
	 */
