...
public enum TimeUnit {
	...
	private static TimeUnit[] inOrder = new TimeUnit[]{NANO_SECOND, MICRO_SECOND, MILLIS_SECOND, SECOND, MINUTE, HOUR, DAY, MONTH, YEAR};
	...
	public long matchTime(String time){
		...
		if(unit == null) unit = TimeUnit.SECOND;
