 ...
 * Les différentes langues pouvant être supportées sont representées par l'énumération {@link fr.badblock.gameapi.utils.i18n.Locale}.
 * 
 * @author LeLanN
 */
public interface I18n {
	/**
	 * Tous les langages de l'énumération Locale ne sont pas forcémment traduit. Cette méthode permet de récupérer
	 * les quels le sont.
	 ...
	 * 
	 * @param locale La langue à trouver
	 * @return La langue trouvée (si elle n'existe pas, la langue par défaut est envoyée)
	 */
	 ...
	 * @param args Les arguments à remplacés dans le message (%0 le premier, %1 le deuxième, ..., %n le énième)
	 * 
	 ...
	 * Le système va rechercher la langue la plus adaptée.
	 * 
	 * @param sender Le CommandSender (Bukkit)
	 * @param key La clé du message dans le ficher configuration
	 * @param args Les arguments à remplacer dans le message (%0 le premier, %1 le deuxième, ..., %n le énième)
	 */
	 ...
	 * Le système va rechercher la langue la plus adaptée pour tous les joueurs.
	 * 
	 * @param key La clé du message dans le ficher configuration
	 * @param args Les arguments à remplacer dans le message (%0 le premier, %1 le deuxième, ..., %n le énième)
	 */
	...
	/**
	 * Permet de remplacer de manière plus rapide les couleurs.
	 * Appel en réalité ChatColor.translateAlternateColorCodes.
	 * @param base Le message à formatter
	 * @return Le message remplacé
	 */
	public String replaceColors(String base);
	
	/**
	 * Permet de remplacer de manière plus rapide les couleurs, pour plusieurs messages.
	 * Appel en réalité ChatColor.translateAlternateColorCodes.
	 * @param base Les messages à formatter
