...
public interface CustomCreature {
	...
	public enum CreatureBehaviour {
		/**
		 * L'entité ne peut pas se déplacer ou tourner la tęte. Elle n'est pas
		 * non plus sensible ŕ la gravité.
		 */
		MOTIONLESS,
		/**
	...
	/**
	 * List les attributs appliquable ŕ l'entité
	 * 
	 * @author LeLanN
	 */
	...
	/**
	 * Récupčre le comportement de l'entité
	 * 
	...
	/**
	 * Récupčre un attribut générique de l'entité
	 * 
	 * @param attribute
	 *            L'attribut
	 * @return La valeur
	...
	/**
	 * Récupčre le type de la créature.
	 * 
	...
	/**
	 * Récupčre une liste des flags de l'entité
	 * 
	 * @return Les flags
	 */
	...
	/**
	 * Vérifie si l'entité ŕ des flags
	 * 
	 * @param flag
	 *            Les flags
	...
	/**
	 * Met ŕ jour le comportement de l'entité avec les flags actuels (appelé
	 * automatiquement)
	 */
	public void regenerateAttributes();

	/**
	 * Enlčve un flag ŕ l'entité
	 * 
	 * @param flag
	 *            Le flag
	 */
