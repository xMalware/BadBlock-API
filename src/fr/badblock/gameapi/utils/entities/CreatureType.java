 ...
 * 
 * Permet aussi la traduction grâce ŕ getKey().
 * 
 * @author LeLanN
 */
public enum CreatureType {
	...
	/**
	 * Récupčre une CreatureType via une EntityType Bukkit
	 * 
	 * @param bukkit
	 *            L'EntityType Bukkit
	...
	/**
	 * Récupčre une CreatureType via une entité Bukkit
	 * 
	 * @param bukkit
	 *            L'entité Bukkit
	 * @return La CreatureType (si non trouvé, null)
	...
	/**
	 * Récupčre un CreatureType ŕ partir du nom de l'entité
	 * 
	 * @param name
	 *            Le nom
	...
	/**
	 * Récupčre l'EntityType équivalent
	 * 
	 * @return L'EntityType
	 */
	...
	/**
	 * Fait spawn une nouvelle entité du type du CreatureType ŕ une certaine
	 * position
	 * 
	 * @param l
	 *            La location
