...
/**
 * Classe d'aide ŕ la gestion des différentes créatures MineCraft.
 * 
 * @author LeLanN
 */
public class CreatureUtils {
	 ...
	 * @param entity
	 *            L'entité.
	 * @return La version modifiée de la créature. Attention, peut ętre null !
	 */
	 ...
	 * 
	 * @param world
	 *            Le monde oů se trouve l'entité
	 * @param entityId
	 *            L'UUID de l'entité.
	 ...
	 * 
	 * @param from
	 *            La location ŕ changer
	 * @param to
	 *            La location ŕ regarder
	 * @param aiming
	 ...
	 * @param clazz
	 *            Le type d'entité ŕ faire spawn
	 */
