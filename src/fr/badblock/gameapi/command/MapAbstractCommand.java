...
public abstract class MapAbstractCommand extends AbstractCommand {
	...
	public MapAbstractCommand(String command, TranslatableString usage, GamePermission permission, String[] aliases, File mapFolder) {
	...
	public void setLookedBlock(boolean addToList, String map, String sub, String key, BadblockPlayer player, Material... allowedMaterials){
		...
		if(blockTarget == null){
			...
			if(!good){
				player.sendTranslatedMessage("commands.wronglookedblock", GameMessages.material(allowedMaterials[0], false, WordDeterminant.UNDEFINED));
			} else {
